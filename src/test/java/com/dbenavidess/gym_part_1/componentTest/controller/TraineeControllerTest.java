...
public class TraineeControllerTest {
    ...
    public void updateTraineeTest() throws JsonProcessingException {
        ...
        RequestSpecification httpRequest = RestAssured.given()
                ...
                .body(request);
        //Act
        mapper.readValue(httpRequest.put().asString(), TraineeProfileResponse.class);
    ...
    public void getNotAssignedTrainersTest() throws JsonProcessingException {
        //Arrange
        service.updateTraineeTrainerList(
        ...
        RequestSpecification httpRequest = RestAssured.given()
                ...
                .header("Authorization", authHeader);
        //Act
        List<TraineeProfileResponse.TraineeTrainerRepr> response = mapper.readValue(httpRequest.get().asString(), new TypeReference<>() {
        });
